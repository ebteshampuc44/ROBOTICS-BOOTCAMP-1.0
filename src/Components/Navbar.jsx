    ...
    <nav className="bg-gradient-to-b from-[#2C4CA7] to-[#4A6ED1] text-white sticky top-0 z-50 shadow-md backdrop-blur-2xl border-b border-[#87CEEB]/30">
      <div className="container mx-auto px-4 sm:px-6 py-2 flex items-center justify-between">
        ...
        <div
          ...
          className="flex items-center gap-2 sm:gap-3 hover:opacity-90 transition cursor-pointer flex-shrink-0 outline-none focus:outline-none"
        >
          <img
            ...
            className="h-10 sm:h-12 md:h-14 w-auto flex-shrink-0 outline-none focus:outline-none"
          />
          <h1 className="font-bold text-sm sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-white whitespace-nowrap overflow-visible flex-shrink-0 outline-none focus:outline-none">
        ...
        <div className="hidden md:flex items-center gap-3 flex-shrink-0">
          <Link to="/curriculum">
            <button className="px-4 py-1.5 rounded-full bg-white text-[#2C4CA7] font-semibold shadow-md hover:bg-gray-200 hover:scale-105 transition-all duration-300 text-sm md:text-base outline-none focus:outline-none focus:ring-0">
              Detailed Curriculum
            </button>
          </Link>
          <Link to="/register">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-md hover:bg-[#2C4CA7] transition flex-shrink-0 outline-none focus:outline-none focus:ring-0"
        >
      ...
      {isOpen && (
        <div 
          ref={mobileMenuRef}
          className="md:hidden flex flex-col items-center gap-3 pb-4 pt-4 bg-gradient-to-b from-[#2C4CA7] to-[#4A6ED1] px-4 border-t border-[#87CEEB]/30"
        >
